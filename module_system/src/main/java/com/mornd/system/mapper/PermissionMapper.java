...
public interface PermissionMapper extends BaseMapper<SysPermission> {
    Set<SysPermission> getPersByRoleIds(@Param("roles") List<String> roleIds, @Param("enabledState") Integer enabledState, @Param("excludeMenuType") Integer excludeMenuType, @Param("hidden") Integer hidden);
